...
var _parser = function(data) {
    ...
    if ( 
        !data.searchResults || 
        !data.searchResults.searchResultsOrder || 
        !data.searchResults.searchResultsOrder.length ||
        !data.searchResults.searchEntryList ||
        !data.searchResults.searchEntryList.items
        ) {
    ...
    let retobj = {
        query : data.query,
        results : data.searchResults.searchEntryList,
    ...
    `;
    //var dup = [];
    data.searchResults.searchEntryList.items.forEach(async function (list) {
        ret += _drawMeans(list);
        //dup.push(list.entryName);
    });
